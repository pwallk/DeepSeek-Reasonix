export const en = {
  ...
  settings: {
    ...
    qqEnabledForCli: "Enabled (CLI)",
    qqConfiguredDisabled: "Configured · disabled",
    qqNotConfigured: "Not configured",
    qqRuntimeNote: "The bot runs in the `reasonix` CLI, not the desktop window. Save credentials here and the next terminal session will start the channel.",
    qqSummaryMissing: "Credentials not configured yet",
    qqSummaryAppId: "App ID {appId}",
    qqSummaryDetail: "{appId} · {environment} · {access}",
    qqConnect: "Enable for CLI",
    qqConfigure: "Configure…",
    qqDisconnect: "Disable",
    qqConfigureTitle: "Configure QQ Channel",
    qqConfigureHint: "Credentials saved here are picked up by `reasonix` in a terminal — this window is the config editor, not the bot runtime.",
    qqBack: "Back",
    qqAppId: "App ID",
