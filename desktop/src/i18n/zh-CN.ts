...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    qqConnected: "已连接",
    qqDisconnected: "已断开",
    qqEnabledForCli: "已启用（终端）",
    qqConfiguredDisabled: "已配置 · 未启用",
    qqNotConfigured: "未配置",
    qqRuntimeNote: "QQ 机器人在 `reasonix` 终端命令里运行，不在桌面窗口里。在这里保存凭据后，下次启动 `reasonix` 终端会话时会自动接入。",
    ...
    qqConfigureHint: "在这里保存的凭据由终端里的 `reasonix` 命令读取——本窗口只是配置编辑器，不是机器人本体。",
    qqBack: "返回",
    qqAppId: "App ID",
